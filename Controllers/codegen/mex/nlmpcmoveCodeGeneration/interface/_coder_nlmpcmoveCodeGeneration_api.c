...
static cell_0 i_emlrt_marshallIn(const mxArray *u,
                                 const emlrtMsgIdentifier *parentId);
...
static const mxArray *b_emlrt_marshallOut(const struct1_T *u)
{
  static const int32_T b_iv1[2] = {3, 2};
  ...
  b_iv[0] = 1;
  b_iv[1] = 4;
  emlrtAssign(&b_y, emlrtCreateCellArrayR2014a(2, &b_iv[0]));
  c_y = NULL;
  ...
  emlrtAssign(&g_y, m);
  emlrtSetFieldR2017b(y, 0, "Slack0", g_y, 5);
  return y;
}
                               ...
                               const emlrtMsgIdentifier *parentId, struct1_T *y)
{
  ...
  y->Parameters =
      i_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u,
                                                        0, 2, "Parameters")),
                         &thisId);
                                 ...
                                 const emlrtMsgIdentifier *parentId)
{
  ...
  bv[1] = false;
  b_iv[1] = 4;
  emlrtCheckCell(emlrtRootTLSGlobal, parentId, u, 2U, &b_iv[0], &bv[0]);
...
static void l_emlrt_marshallIn(const mxArray *u,
                               const emlrtMsgIdentifier *parentId)
{
  s_emlrt_marshallIn(emlrtAlias(u), parentId);
  emlrtDestroyArray(&u);
}
