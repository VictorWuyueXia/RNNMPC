...
static real_T i_emlrt_marshallIn(const mxArray *u,
                                 const emlrtMsgIdentifier *parentId);
...
static const mxArray *b_emlrt_marshallOut(const struct1_T *u)
{
  ...
  emlrtAssign(&g_y, m);
  emlrtSetFieldR2017b(y, 0, "X0", g_y, 3);
                               ...
                               const emlrtMsgIdentifier *parentId, struct1_T *y)
{
  ...
  h_emlrt_marshallIn(emlrtAlias(emlrtGetFieldR2017b(emlrtRootTLSGlobal, u, 0, 2,
                                                    "Parameters")),
                     &thisId, &y->Parameters);
