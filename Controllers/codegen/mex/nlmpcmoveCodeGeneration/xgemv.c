             ...
             const emxArray_real_T *x, int32_T ix0, emxArray_real_T *y)
{
  ...
  if ((m >= 1) && (n >= 1)) {
    ...
    incy_t = (ptrdiff_t)1;
    dgemv(&TRANSA, &m_t, &n_t, &alpha1, (real_T *)&A_data[0], &lda_t,
          (real_T *)&x_data[ix0 - 1], &incx_t, &beta1, &y_data[0], &incy_t);
  }
}
             ...
             const emxArray_real_T *x, emxArray_real_T *y)
{
  ...
  if ((m >= 1) && (n >= 1)) {
    ...
    incx_t = (ptrdiff_t)1;
    incy_t = (ptrdiff_t)1;
    dgemv(&TRANSA, &m_t, &n_t, &alpha1, (real_T *)&A[0], &lda_t,
          (real_T *)&x_data[0], &incx_t, &beta1, &y_data[0], &incy_t);
  }
}
             ...
             int32_T lda, const emxArray_real_T *x, emxArray_real_T *y)
{
  ...
  if ((m >= 1) && (n >= 1)) {
    ...
    incx_t = (ptrdiff_t)1;
    incy_t = (ptrdiff_t)1;
    dgemv(&TRANSA, &m_t, &n_t, &alpha1, (real_T *)&A_data[ia0 - 1], &lda_t,
          (real_T *)&x_data[0], &incx_t, &beta1, &y_data[0], &incy_t);
  }
}
             ...
             const emxArray_real_T *x, emxArray_real_T *y, int32_T iy0)
{
  ...
  if ((m >= 1) && (n >= 1)) {
    ...
    incy_t = (ptrdiff_t)1;
    dgemv(&TRANSA, &m_t, &n_t, &alpha1, (real_T *)&A_data[0], &lda_t,
          (real_T *)&x_data[0], &incx_t, &beta1, &y_data[iy0 - 1], &incy_t);
  }
}
