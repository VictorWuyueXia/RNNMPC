  ...
  const mxArray * prhs[] )
{
  ...
  extern unsigned int sf_autolibshared_process_check_sum_call( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Simulation_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_autolibshared_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Simulation_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_autolibshared_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "autolibshared") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_autolibshared_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Simulation_jit_fallback_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_autolibshared_jit_fallback_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "autolibshared") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_autolibshared_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Simulation_get_post_codegen_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_autolibshared_get_post_codegen_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "autolibshared") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_autolibshared_get_post_codegen_info(nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Simulation_updateBuildInfo_args_info( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_autolibshared_updateBuildInfo_args_info( int nlhs,
  ...
  if (strcmp(machineName, "autolibshared") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_autolibshared_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Simulation_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_autolibshared_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "autolibshared") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_autolibshared_get_eml_resolved_functions_info(nlhs,plhs,3,newRhs);
  }
...
extern unsigned int sf_autolibshared_method_dispatcher(SimStruct *S, unsigned
  ...
  char* specsCksum, int_T method, void *data)
{
  ...
  if (!strcmp(machineName,"autolibshared")) {
    return(sf_autolibshared_method_dispatcher(simstructPtr,chartFileNumber,
            specsCksum,method,data));
  }
...
extern void autolibshared_terminator(void);
