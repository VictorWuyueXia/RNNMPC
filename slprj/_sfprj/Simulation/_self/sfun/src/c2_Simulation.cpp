...
static void initSubchartIOPointersc2_Simulation(SFc2_SimulationInstanceStruct
  *chartInstance);
static real_T c2_sumColumnB(SFc2_SimulationInstanceStruct *chartInstance, real_T
  c2_x[2]);
...
static void c2_chart_data_browse_helper(SFc2_SimulationInstanceStruct
  ...
  *c2_isValueTooBig);
static int32_T c2__s32_add__(SFc2_SimulationInstanceStruct *chartInstance,
  int32_T c2_b, int32_T c2_c, int32_T c2_EMLOvCount_src_loc, uint32_T
  c2_ssid_src_loc, int32_T c2_offset_src_loc, int32_T c2_length_src_loc);
static int32_T c2__s32_minus__(SFc2_SimulationInstanceStruct *chartInstance,
  int32_T c2_b, int32_T c2_c, int32_T c2_EMLOvCount_src_loc, uint32_T
  c2_ssid_src_loc, int32_T c2_offset_src_loc, int32_T c2_length_src_loc);
  ...
  (SFc2_SimulationInstanceStruct *chartInstance)
{
  ...
  covrtEmlFcnInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U,
                     "eML_blk_kernel", 0, -1, 664);
  covrtEmlIfInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U, 457, 468, -1,
                    660, false);
  covrtEmlIfInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 1U, 519, 542, -1,
                    652, false);
  covrtEmlRelationalInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U, 522,
    542, -1, 2U);
}
  ...
  *chartInstance)
{
  ...
  for (c2_i7 = 0; c2_i7 < 2; c2_i7++) {
    c2_wp1[c2_i7] = c2_b_waypoints[c2_i6];
    c2_i6 += 12;
  }

  for (c2_i8 = 0; c2_i8 < 2; c2_i8++) {
    c2_b_pos[c2_i8] = c2_wp1[c2_i8] - c2_b_pos[c2_i8];
  }
  ...
  for (c2_c_k = 0; c2_c_k < 2; c2_c_k++) {
    c2_d_k = c2__s32_add__(chartInstance, c2_c_k, 1, 0, 1U, 438, 6);
    c2_a = c2_b_vel[c2__s32_minus__(chartInstance, c2_d_k, 1, 0, 1U, 438, 6)];
    c2_c_y = c2_a * c2_a;
    c2_b_pos[c2__s32_minus__(chartInstance, c2_d_k, 1, 0, 1U, 438, 6)] = c2_c_y;
  }

  c2_varargin_2 = c2_sumColumnB(chartInstance, c2_b_pos);
  c2_y = c2_varargin_2;
  c2_b_y = c2_y;
  c2_d_y = c2_b_y;
  c2_b = c2_d_y;
  c2_e_y = c2_b;
  c2_f_y = c2_e_y;
  c2_perimeter = muDoubleScalarMax(3.0, c2_f_y);
  for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
    c2_x_data[c2_i9] = c2_wp1[c2_i9];
  }
  ...
  while ((!c2_exitg1) && (c2_e_k < 2)) {
    c2_f_k = static_cast<real_T>(c2_e_k) + 1.0;
    if (c2_x_data[static_cast<int32_T>(c2_f_k) - 1] == 0.0) {
      c2_g_y = false;
      c2_exitg1 = true;
    } else {
      c2_e_k++;
  ...
  if (covrtEmlIfEval(chartInstance->c2_covrtInstance, 4U, 0, 0, c2_g_y) &&
    ...
    for (c2_i13 = 0; c2_i13 < 2; c2_i13++) {
      for (c2_i16 = 0; c2_i16 < 11; c2_i16++) {
        c2_c_waypoints[c2_i16 + c2_i10] = c2_b_waypoints[(c2_i16 + c2_i12) + 1];
      }
    ...
    for (c2_i18 = 0; c2_i18 < 2; c2_i18++) {
      for (c2_i20 = 0; c2_i20 < 11; c2_i20++) {
        c2_b_waypoints[c2_i20 + c2_i15] = c2_c_waypoints[c2_i20 + c2_i17];
      }
    ...
    for (c2_i21 = 0; c2_i21 < 2; c2_i21++) {
      c2_b_waypoints[c2_i19 + 11] = rtNaN;
      c2_i19 += 12;
    }
  }

  for (c2_i11 = 0; c2_i11 < 24; c2_i11++) {
    (*chartInstance->c2_newWaypoints)[c2_i11] = c2_b_waypoints[c2_i11];
  }
  ...
  for (c2_i14 = 0; c2_i14 < 24; c2_i14++) {
    covrtSigUpdateFcn(chartInstance->c2_covrtInstance, 3U,
                      (*chartInstance->c2_newWaypoints)[c2_i14]);
  }
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2460065391U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3829413994U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1462364002U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2304232762U);
}
...
{
  return "sg2FF7BrUkQ100ZoKoE8G4E";
}
...
const char* sf_c2_Simulation_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [21] = {
    "eNrdWE9vG0UUX7shalEaVRUSPSDRIxckJ4AoEoIk9rpYJCRgp5V6iSa7z96RZ2e288eOuXDms3D",
    "px+AbwIETn4BjL0i8Wa9dd23imXURbVfaTGZ3f/Pe+837Nw5qnZMAr128G/eCYBvHm3jXg+n1Tj",
    "GvLdzT51vBl8X813eDIBIxDIB3Tb9PrwK/i5v0jEiSqsD/4iSFH0AJZjQVvMP7wh1LeR8k8AgXy",
    "ITUXnIVTQ2jfNg2PLKS1eOERkk3EYbFR7ggiU85m/yb3MzoM5TYohIi3QaIdSKFGSRtRgbXsyD1",
    "uJlANFQm9eZKge6azJqqTgzTNGMQXkHU4UoTZEGtsberiYamvvIj2dqrujO0SDNGCXfnOiGqCxl",
    "6h4bzLMa/p0Yje45yUd4l5UQLSQkLU9ZMiHTFnjHU8wTdmnnzrFPdgkszGFA+sOxKkwJH+9FPHL",
    "jqN8UIJBnAKfeTG1nrwqt8g+d+6YjVNIVHRB5G6AcKYr8YRAdWXYJbCz1cxgsLnFwy6KiepCPcI",
    "9+80bGhVClvmHTqSaoSNpcbjnBXVUW57Yg3CWPKD9sT2TGMgOXyW0STCtipfA+wUjTuCfQOG7me",
    "0W84fWqgwDYFj6m7V45KqLxIfIcJ3wFOUxsGECPNc9XnC62LI6O0SJsY+q3jY0d5y9gO1yD7JAL",
    "nfC0JVYAK537lKTemygYSopElnVvpvMI0BitBA9U3vDUWcogc+xaGF1zZSPBDQzyAFmjIk1yI3v",
    "2IMOOoc6owK1v3OFeYZf3kItbGTyVwRKIEYlsDKYMTzLO4gOsWK1s+D9HaEdWTFqhI0sw1kgwmd",
    "Cx+lqXeJINzPuRizNtSpN2ii7nGrwAwaxDJsZQdYSmVkzYq76a1hKe9PLv7NgyWZ6IZubS+8RA4",
    "VkNrq63eJMKoCjm2m6jQJtgu/RHbEa6o0tgCTsI8BuK8Dz4IXvTBWyv64NsLffCdYh7tX+Rkzop",
    "83k8vrLPj0E8HDrhgCRfMcbPxowV8bYXcYGEsy7tVf/n7GyV5dXxSq9WWeLpdkrNVwm0XXD376f",
    "kvf2R/ju9+8ffez43f7q6TX1uSX8v/t7hndb/zym4x/2DWK80z82gpedlvv1njB++X/MDO1WC/3",
    "f78SJ4Pv99rNJ6Ib0X44OGn4XR/1uhbL+k7e37f9mcYuHkekFEnLs49dk7MtB+36z9Y0Hd7DR+3",
    "FvwpCP76ejP8ewcucbNT4msn7x3Hj8kkE7TopBb9uLo+9w82w1fff6ouiM3ScPFyRth1jLfr/N0",
    "X96bIe9v1fJX2udSRGxVxtf+wbr1K3Kb2+dbHN/37xjV5LCh9f+c1tqM8Vu2TXje7fg/8+pgPi/",
    "lX87N5M6EsXnE6KF5jA99f9fYt8e/nnvzN6nZo+St+EH3yySEnbILHgelxq3h8Ju1vcfNXEohaf",
    "eb6P+rJbKzSd40pj8VYfby3/9n+JvXpH16YCIA=",
    ""
  };
...
static void mdlSetWorkWidths_c2_Simulation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2885189552U));
  ssSetChecksum1(S,(2011328732U));
  ssSetChecksum2(S,(838678802U));
  ssSetChecksum3(S,(316092553U));
}
