...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2023b\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"C:\MATLAB\R2023b\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -Wl,"C:\MATLAB\R2023b/extern/lib/win64/mingw64/mexFunction.def"
...
gmake SHELL="cmd" -f Simulation_cgxe.gmk
