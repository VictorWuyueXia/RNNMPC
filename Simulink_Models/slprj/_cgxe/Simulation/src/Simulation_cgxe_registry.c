...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 317658419;
  checksumData[1] = 2636810884;
  checksumData[2] = 3491679627;
  checksumData[3] = 1858911522;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 447962728;
    checksumData[1] = 3200047672;
    checksumData[2] = 784042886;
    checksumData[3] = 4255502707;
...

  {
    ...
    checksumData[0] = 2805878209;
    checksumData[1] = 2525441352;
    checksumData[2] = 1136635018;
    checksumData[3] = 3695820186;
...

  {
    ...
    checksumData[0] = 3096000139;
    checksumData[1] = 4099391926;
    checksumData[2] = 1280195398;
    checksumData[3] = 1882125975;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "IGTuDum22hMqh6nRrDjsgF") == 0) {
    extern mxArray *cgxe_IGTuDum22hMqh6nRrDjsgF_BuildInfoUpdate(void);
    plhs[0] = cgxe_IGTuDum22hMqh6nRrDjsgF_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "IGTuDum22hMqh6nRrDjsgF") == 0) {
    extern mxArray *cgxe_IGTuDum22hMqh6nRrDjsgF_fallback_info(void);
    plhs[0] = cgxe_IGTuDum22hMqh6nRrDjsgF_fallback_info();
    return 1;
  }
