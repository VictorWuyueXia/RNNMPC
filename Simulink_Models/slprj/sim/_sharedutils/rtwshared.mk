...
MODEL                   = rtwshared
MODULES                 = look1_binlcpw.c look1_binlxpw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
PRODUCT                 = rtwshared.a
MAKEFILE                = 
...
NCSTATES                = 0
COMPUTER                = MACA64
BUILDARGS               =  OPTS="-DNRT -DIS_SIM_TARGET" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=11.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
