...
) { f0nsmguvnxb * dw = ( f0nsmguvnxb * ) ssGetDWork ( S , 0 ) ; real_T *
...
ssGetContStates ( S ) ; real_T const * i_mn1qqsn43k = ( real_T * )
ssGetInputPortSignal ( S , 0 ) ; real_T const * i_n4dvpijfyd = ( real_T * )
ssGetInputPortSignal ( S , 1 ) ; if ( tid == 0 ) { Dynamics ( & ( dw -> rtm )
, o_B_3_1 , o_B_3_2 , o_B_3_3 , o_B_3_4 , o_B_3_5 , o_B_3_6 , o_B_3_7 ,
o_B_3_8 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; mfwe15whbn ( & ( dw
-> rtm ) , i_mn1qqsn43k , i_n4dvpijfyd , & ( dw -> rtdw ) ) ; } } static void
...
if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 7 ,
unitIdReg ) ;
#endif
...
ssSetSampleTime ( S , 1 , 0.005 ) ; ssSetOffsetTime ( S , 1 , 0 ) ;
...
ssGetDWork ( S , 0 ) ; gjr2vlvgbm ( & ( dw -> rtb ) ) ; } static void
mdlOutputs ( SimStruct * S , int_T tid ) { f0nsmguvnxb * dw = ( f0nsmguvnxb *
) ssGetDWork ( S , 0 ) ; real_T * o_B_3_1 = ( real_T * )
...
( & ( dw -> rtm ) , o_B_3_1 , o_B_3_2 , o_B_3_3 , o_B_3_4 , o_B_3_5 , o_B_3_6
, o_B_3_7 , o_B_3_8 , & ( dw -> rtb ) , & ( dw -> rtdw ) , localX ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { f0nsmguvnxb * dw = (
f0nsmguvnxb * ) ssGetDWork ( S , 0 ) ; real_T const * i_mn1qqsn43k = ( real_T
* ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_n4dvpijfyd = ( real_T *
) ssGetInputPortSignal ( S , 1 ) ; mfwe15whbn ( & ( dw -> rtm ) ,
i_mn1qqsn43k , i_n4dvpijfyd , & ( dw -> rtdw ) ) ; return ; }
