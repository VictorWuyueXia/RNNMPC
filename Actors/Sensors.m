classdef Sensors
    ...
    methods
        ...
        function obj=defaultConfig(obj)
            ...
            % Front camera with 120deg FOV and 150m range, 1080p
            Camera_EgoCar0_Front=Camera_Params(1920, 1080, 120);
            Camera_EgoCar0_Front.Direction=0; % deg
            Camera_EgoCar0_Front.Range_Max=150; % meters

            % % Back camera with 90deg FOV and 150m range, 1080p
